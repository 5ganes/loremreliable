...
<form action="<?= $_REQUEST['uri'];?>" method="post" onsubmit="return frmvalidate(this)" enctype="multipart/form-data">
        <table width="100%" border="0" cellspacing="2" cellpadding="0">
          ...
          <tr>
            ...
            <td>
              <input type="text" style="margin: 4px 0px;padding:2px;" name="name" id="name" onchange="copySame('urlname', this.value);" value="" style="width:200px">
            </td>
          </tr>
          <tr><td></td></tr>
          <tr>
            ...
            <td>
              <input type="text" style="margin: 4px 0px;padding:2px;" name="urlname" id="urlname" value="" style="width:200px">
            </td>
          </tr>
          <tr><td></td></tr>
          <!-- <tr>
...
?>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
               ...
               <tr>
                ...
                <td>
                  <input type="text" style="margin: 4px 0px;padding:2px;" name="name" id="name" onchange="copySame('urlname', this.value);" value="<?=$row['name'];?>" style="width:200px">
                </td>
              </tr>
              <tr><td></td></tr>
              <tr>
                ...
                <td>
                  <input type="text" style="margin: 4px 0px;padding:2px;" name="urlname" id="urlname" value="<?=$row['urlname'];?>" style="width:200px">
                </td>
              </tr>
              <tr><td></td></tr>
              <!-- <tr>
          ...
          <tr>
            <td colspan="3">
              <div id="fckEditor" class="groupBox" style="width:730px; margin-left:20px">
                <textarea id="shortcontents" name="shortcontents"><?=$row['shortcontents'];?></textarea>      
              </div>
            </td>
          </tr>
          <tr><td></td></tr>
